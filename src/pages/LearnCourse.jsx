  ...
  if (!learningState.isEnrolled) {
    return (
      <div className="section-shell py-20 text-center mx-auto max-w-xl">
        ...
        <Link to={`/courses/${course.slug}`} className="btn-primary">Return to Course Page</Link>
      </div>
    )
  }
        ...
        <div className="space-y-6">
           ...
           <div className="surface-card border-emerald-500/20 bg-emerald-500/5">
              ...
              <p className="mt-2 text-sm text-ink/70 dark:text-gray-400 leading-relaxed">
                 Focused on practical semiconductor design and AI system implementation. Access provided only to enrolled students.
              </p>
           </div>
        </div>
      </section>

      {/* Feedback Modal (Kept Existing Modal) */}
      {feedbackTarget && (
